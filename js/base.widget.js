            ...
            var link = document.createElement('a'),
                ...
                for(var elem in obj){
                    if( obj.hasOwnProperty(elem) &&
                        (elem !== 'url' && elem !== 'trackUrl' && elem !== 'advTrack' && elem !== 'type' && (obj[elem] !== false || elem === 'image') ) ){
                        var sub = false,
                ...
                link.appendChild(el);
                    upCloo.utils.bind(link,'mousedown',function(){
                        ...
                        var trackUrl = obj.trackUrl + ((!isAdv && that.options.ga === true) ? '?ga=' + upCloo.utils.base64.encode( 'inline|' + that.options.theme + vk ) : '' );
                        if(isAdv)trackUrl += '/adv' + ((obj.advTrack) ? "?advTrack=" + obj.advTrack : "");
